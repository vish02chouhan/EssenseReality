...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class AddUpdateResidentialLeaseProperty : AddUpdateResidentialProperty {
    /// <summary>
    ...
    public ID PropertyManager { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class AddUpdateResidentialLeaseProperty {\n");
