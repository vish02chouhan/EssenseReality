...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class ResidentialLeaseProperty : ResidentialProperty {
    /// <summary>
    /// Gets or Sets Branch
    /// </summary>
    ...
    /// <summary>
    /// Gets or Sets CurrentTenancy
    /// </summary>
    [DataMember(Name="currentTenancy", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "currentTenancy")]
    public Tenancy CurrentTenancy { get; set; }

    /// <summary>
    /// Gets or Sets PropertyManager
    /// </summary>
    [DataMember(Name="propertyManager", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "propertyManager")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class ResidentialLeaseProperty {\n");
      ...
      sb.Append("  CurrentTenancy: ").Append(CurrentTenancy).Append("\n");
      sb.Append("  PropertyManager: ").Append(PropertyManager).Append("\n");
